  ...
  return (
    <div className="bg-black min-h-screen overflow-x-hidden">
      ...
      <section className="relative h-screen flex flex-col items-center justify-center px-6 text-center overflow-hidden">
        ...
        <div className="absolute inset-0 z-10" style={{ background: 'radial-gradient(ellipse at center, transparent 20%, rgba(0,0,0,0.9) 100%)' }} />
      ...
      <section id="projects-mobile" className="px-6 py-20 border-t border-white/5">
        ...
        <FadeIn delay={0.1}>
          <div className="border border-white/5 rounded-2xl overflow-hidden">
            <div className="p-6 bg-gradient-to-br from-violet-500/10 to-transparent">
              <div className="text-xs text-white/20 tracking-widest mb-3">{t.projects.type} · 2026</div>
              <h3 className="text-3xl font-bold text-white mb-3">🦒 Jiraffic</h3>
              <p className="text-white/40 text-sm leading-relaxed mb-5">
                {t.projects.jiraffic_desc}
              </p>
              <div className="flex flex-wrap gap-1.5 mb-6">
                {['Next.js 15', 'TypeScript', 'Supabase', 'Gemini AI'].map((tech) => (
                  <span key={tech} className="px-2.5 py-1 border border-white/10 rounded-full text-xs text-white/30">
                    {tech}
                  </span>
                ))}
              </div>
              <div className="flex gap-3">
                <a
                  href="https://jiraffic.vercel.app"
                  target="_blank"
